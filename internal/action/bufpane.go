...
var BufKeyActions = map[string]BufKeyAction{
	...
	"SelectNextTextOccurrence":     (*BufPane).SelectNextTextOccurrence,
	"SelectPreviousTextOccurrence": (*BufPane).SelectPreviousTextOccurrence,
	...
	"FindSelected":                 (*BufPane).FindSelected,
