...
// VSplitCmd opens vertical splits with the files given as arguments
...
// HSplitCmd opens horizontal splits with the files given as arguments
// If no file is given, it opens an empty buffer in a new split
...
// NewTabCmd opens new tabs with the files given as arguments
