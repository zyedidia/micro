...
// runtime/plugins/linter/test.txt
...
var _runtimePluginsLinterTestTxt = ""

func runtimePluginsLinterTestTxtBytes() ([]byte, error) {
	return bindataRead(
		_runtimePluginsLinterTestTxt,
		"runtime/plugins/linter/test.txt",
	)
}

func runtimePluginsLinterTestTxt() (*asset, error) {
	bytes, err := runtimePluginsLinterTestTxtBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "runtime/plugins/linter/test.txt", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"runtime/plugins/linter/test.txt":                         runtimePluginsLinterTestTxt,
	...
	"runtime": &bintree{nil, map[string]*bintree{
		...
		"plugins": &bintree{nil, map[string]*bintree{
			...
			"linter": &bintree{nil, map[string]*bintree{
				...
				"test.txt":   &bintree{runtimePluginsLinterTestTxt, map[string]*bintree{}},
			}},
