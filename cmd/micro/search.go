...
func Search(searchStr string, v *View, down bool) {
	...
	v.Cursor.SetSelectionStart(FromCharPos(charPos+runePos(match[0], str), v.Buf), false)
	v.Cursor.SetSelectionEnd(FromCharPos(charPos+runePos(match[1], str), v.Buf), false)
