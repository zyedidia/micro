...
func runtimeHelpHelpMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "runtime/help/help.md", size: 2942, mode: os.FileMode(420), modTime: time.Unix(1461500930, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
